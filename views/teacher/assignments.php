...
<p>
    <a class="btn btn-primary" href="index.php?controller=TeacherController&action=assignmentCreate&group_id=<?php echo $group['id']; ?>">Create Assignment</a>
</p>
        ...
        <?php else: ?>
            <?php foreach ($assignments as $a): ?>
                <tr>
                    ...
                    <td>
                        <a href="index.php?controller=TeacherController&action=submissions&assignment_id=<?php echo $a['id']; ?>">Submissions</a>
                    </td>
                </tr>
            <?php endforeach; ?>
        <?php endif; ?>
